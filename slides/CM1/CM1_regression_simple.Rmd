...
https://www.lpsm.paris/pageperso/guyader/polysM.html
...
## Regression line
abline(a = beta_hat_0, b = beta_hat_1, col = "blue", lwd = 2)
## Ideal line
...
## Regression lines
abline(a = coef(lm(y_test_all[, i] ~ x_test))[1], b = coef(lm(y_test_all[, i] ~ x_test))[2], col = "blue", lwd = 2)
## Ideal line
abline(a = beta_0, b = beta_1, col = "red", lwd = 2)
...
i <- 10
## Dataset
plot(x_test, y_test_all[, i], pch = 16, cex = 0.7, ylab = "y_test_4")
## Regression lines
abline(a = coef(lm(y_test_all[, i] ~ x_test))[1], b = coef(lm(y_test_all[, i] ~ x_test))[2], col = "blue", lwd = 2)
## Ideal line
abline(a = beta_0, b = beta_1, col = "red", lwd = 2)
...
for (i in 1:r) {
  ...
  abline(a = coef(lm(y_test_all[, i] ~ x_test))[1], b = coef(lm(y_test_all[, i] ~ x_test))[2], col = "blue", lwd = 0.5)
}
## Ideal line
abline(a = beta_0, b = beta_1, col = "red", lwd = 2)
```
...
&= \beta_0 + \beta_1 x_{n+1} - \beta_0 - \beta_1 x_{n+1} = 0\\
\end{aligned}
$$
