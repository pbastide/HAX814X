...
Can we write this as a linear model ?
...
As $\boldsymbol{\beta} = (\mu_f, \mu_m - \mu_f)^T$, the test
$$
...
for any pair $(s_1,s_2)$ of species $\to$ ${|S| \choose 2 }$ tests.
...
<!-- ************************************************************************ -->
# One factor ANOVA - Parametrization
<!-- ************************************************************************ -->
...
F 
&= \frac{
\|\hat{\mathbf{y}}_{\eta_2} -  \hat{\mathbf{y}}_{\eta_2}\|^2 / (|\eta_2| - |\eta_1|)
}{
\|\mathbf{y} - \hat{\mathbf{y}}\|^2 / (n - p)
}\\
&= \frac{
...
## Two factor ANOVA - Type I Table {.smaller}
...
## Two factor ANOVA - Type II Table {.smaller}
...
**Question**: what is the relationship between bill length abd depth, controlling for the species ?
