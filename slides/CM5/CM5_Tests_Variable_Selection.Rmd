...
When we add a "junk" variable, $- \log \hat{L}_\eta$ decreases, but not a lot.

**Quetions**: an we find a good penalty that compensates for this noisy increasing ?
...
$$
BIC = - 2\log \hat{L}_\eta + |\eta| \ln(n)
$$
