...
**Note**: if $n$ is large, $t_{n-p-1}(1-\alpha/2) \approx 1.96$.
...
```{r ad7}
## linear model
fit <- lm(sales ~ sqrt(TV) + radio + radio * TV, data = ad)
```
...
$h_ii$ gives the "weight" of each observation on its own prevision.
