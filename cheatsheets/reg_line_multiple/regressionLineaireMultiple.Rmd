...
[N.B]:  $\mathcal{M}(X)$ est appelé espace image ou encore despace des solutions.
...
MCO est optimal en au sens de Gauss-Markov.
...
et $\hat{Y}$ ( $\theta_0$ ) pris à l'origine. Il n'est cependant pas infaillible car il ne
