...
1. L'estimateur du maximum de vraisemblance de la variance $\hat{\sigma}^2$ est non biaisé
    a. Oui
    a. Non
1. Les estimateurs du maximum de vraisemblance $\hat{\beta}_0$ et $\hat{\beta}_1$ sont les estimateurs avec la plus petite variance parmis les estimateurs linéaires
    a. Oui
    a. Non
...
explicatives** ? (En supposant les vecteurs $\mathbf{1}$ et $\mathbf{x}$ indépendants.)
    a. $n - 1$
    a. $n - 2$
    a. $n - 3$
    a. $n - 4$
