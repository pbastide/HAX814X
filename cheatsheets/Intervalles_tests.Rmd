...
Il y a $n-p$ degrés de liberté, et si $X_1=1$ (premiére colonne) est l'intercept alors il y
...
\sim
\mathcal{N}\left(0~~;~\sigma^2 \left(1 + \mathbf{x}^{n+1} (X^TX)^{-1}(x^{n+1})^T\right)\right)
$$
...
On rejette (risque d'erreur 5%) $H_0$ l'hypothése de nullité pour les deux coefficients
